            ...
            if (context != null)
            {
                ...
                if (!context.Users.Any())
                {
                    context.Users.AddRange(
                        ...
                        new User { UserName = "baykutay", Image = "p2.jpg", Name = "Baykutay Turan", Email = "baykutayturan@gmail.com", Password = "545454",VerificationCode = "872400",IsVerified= true },
                ...
                if (!context.Tags.Any())
                {
                    context.Tags.AddRange(
                        ...
                        new Tag { Text = "Gündem", Url = "gundem", Color = TagColors.success },
